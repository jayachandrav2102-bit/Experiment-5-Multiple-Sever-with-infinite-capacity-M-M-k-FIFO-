...
https://colab.research.google.com/drive/19ax5jevT5i38Icq4vBUQiHn02l-XFzYy#scrollTo=2ESLcuWwhUsa
~~~
# Output
~~~
Enter the mean inter arrival time of objects from feeder (in sec):10
